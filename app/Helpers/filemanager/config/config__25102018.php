...
*/
$iGeneralJournalId = "/";
if(isset($_SESSION['gj_id'])) {
    $iGeneralJournalId = $_SESSION['trans_date']."/".$_SESSION['gj_id']."/";
}
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '../../uploads/source/'.$iGeneralJournalId,
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../../uploads/source/'.$iGeneralJournalId,
	...
	|
	*/
	'thumbs_base_path' => '../../uploads/thumbs/'.$iGeneralJournalId,
	...
	*/
	...
	|--------------------------------------------------------------------------*/
	'ftp_thumbs_dir' => '../../uploads/thumbs/'.$iGeneralJournalId,
	'ftp_ssl' => false,
	'ftp_port' => 21,
