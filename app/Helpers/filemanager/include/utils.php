...
if ( ! function_exists('trans'))
{
	...
	else
	{
        ...
        //app_path() . '\helpers\filemanager\lang
	if(file_exists(app_path() . '\helpers\filemanager\lang'. $lang . '.php')){
		$lang_vars = include app_path() . '\helpers\filemanager\lang'. $lang . '.php';
	}else{
		$lang_vars = include app_path() . '\helpers\filemanager\lang'. $lang . '.php';
	}
